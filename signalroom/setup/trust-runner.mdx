...
The **Team ID** is auto-detected from your account. If your team is brand new with no registered identifiers yet, the wizard asks for the Team ID manually — it's the 10-character string in the top-right corner at <https://developer.apple.com/account>.
